...
local = get_localzone()
cluster_name = "spark-streaming-etl"  # cluster in which kafka & zookeeper are installed
...
while flag:
    ...
    producer = KafkaProducer(bootstrap_servers=[cluster_name + '-w-0:9092'],
    ...
    json_str = {"date_time": dt, "state": fake_state, "ip_address": ip, "category": uri_segments[0],
                'sub_cat': uri_segments[1], 'type': uri_segments[2], "pid": pid}
